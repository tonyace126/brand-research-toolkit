...
description: Research brand issues, controversies, or campaigns across YouTube, PTT, Dcard, Mobile01, news sites, Threads, FB, and X (Twitter). Use when user says "research X brand discussion", "find what people say about Y", "track [brand] [topic] across platforms", "盤點 X 品牌話題", "研究 X 在 PTT/YouTube 怎麼被討論", "X 議題輿情", "競品聲量比較", or wants a structured cross-platform brand sentiment / topic landscape. Dispatches parallel agents per platform, returns structured tables + observation summary.
---
...
| X (Twitter) | ⚠️ 牆 | 新聞轉引 / KEYPO | references/platforms/x-twitter.md |
